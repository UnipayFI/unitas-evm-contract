...
contract E2eTestingDeployment is Script, FullDeployment {
  ...
  function run() public override {
    ...
    deployedContracts.USDuToken.setMinter(deployer);
    deployedContracts.USDuToken.mint(testerAddress, _DEFAULT_MOCK_TOKEN_PRICE * _DEFAULT_TEST_DEPOSIT_SIZE);
    deployedContracts.USDuToken.setMinter(address(deployedContracts.unitasMintingContract));
    vm.stopBroadcast();
  }
}
